...
from ..store import (
    create_hash, DraftRepo, FileInfo,
    Dependency, Link, LinkCollection,
    Snapshot, SnapshotRepo, StagedDraft,
)
...
class TestTransitiveLinks(unittest.TestCase):
    ...
    def test_cycle_detection(self):
        with self.assertRaises(ValueError):
            updated_links = self.links_for_course.with_updated_link(
                Link(
                    name="circular_link",
